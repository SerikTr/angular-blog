...
var AuthServices = /** @class */ (function () {
    ...
    Object.defineProperty(AuthServices.prototype, "token", {
        get: function () {
    ...
    AuthServices.prototype.handleError = function (error) {
    ...
    AuthServices.prototype.setToken = function (response) {
        if (response) {
    ...
    AuthServices.ctorParameters = function () { return [
