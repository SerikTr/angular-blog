...
let CreatePageComponent = class CreatePageComponent {
    ...
    submit() {
        ...
        this.postsService.create(post).subscribe(() => {
            this.form.reset();
            this.alert.success('Congratulations, the post was added !');
        });
    }
};
...
let DashboardPageComponent = class DashboardPageComponent {
    ...
    remove(id) {
        this.dSub = this.postService.remove(id).subscribe(() => {
            ...
            this.alert.warning('The post was remove !');
        });
    }
    ngOnDestroy() {
        if (this.pSub) {
...
let EditPageComponent = class EditPageComponent {
    constructor(route, postsServices, alert) {
        this.route = route;
    ...
    submit() {
        ...
        this.submitted = true;
        this.uSub = this.postsServices.upDate(Object.assign({}, this.post, { text: this.form.value.text, title: this.form.value.title })).subscribe(() => {
            this.submitted = false;
            this.alert.success('Congratulations, the post was refreshed!');
        });
    }
};
